...
، پلتفورمی سخت‌افزاری بسیار ایمنی به منظور ذخیره‌ی نرم‌افزارها و داده‌های محرمانه و رمزگذاری شده است. بنابراین 
{\normalsize \lr{SE}}
...
{\normalsize \lr{SE}}
ها به منظور ذخیره‌سازی نرم‌افزار‌های کارت و کلیدهای مخصوص رمزنگاری که ملزومات تراکنش‌های مالی
{\normalsize \lr{EMV}}
بوسیله‌ی 
{\normalsize \lr{POS}}
هستند ،
...
{\normalsize \lr{SE}}			
	سهولت یکی شدن آسان‌تر با شخص ثالث را به همواه خواهد داشت.
...
برای نسبت دادن داده‌ها و ساختن آن‌ها استفاده می‌کنند.  
	...
	برای ساخت و اجرای پرسجو‌ها در محیط شیءگرایی و واکاوی اشیاء به کار می‌روند.		
...
public void setIdstore(Integer idstore) {this.idstore = idstore;}
	...
	{\normalsize \lr{‌POJO}}
	، فایل نگاشت و آماده کردن جداول پایگاه داده برای اتصال به آن‌ها، 
	{\normalsize \lr{‌‌Hibernate}}
...
در پروژه از مقادیر پیش‌فرض به منظور ذخیره‌ی مقادری احراز هویت و وضعیت نرم‌افزار مورد استفاده قرار گرفته است. 
...
{\normalsize \lr{‌Sruct}}
	...
	مناسب به منظور کدگشایی داده‌ها پیاده می‌شود. 
