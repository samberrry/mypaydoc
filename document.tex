...
\end{figure}
	...
	\subsection{ {\footnotesize \lr{Starbucks}}}
	...
	 	 			 									 
		\subsection{ {\footnotesize \lr{Royal Bank of Canada (RBC)}}}
		ویژگی : کارت‌های هدیه ، رسید‌های دیجیتالی
		
		بزرگ‌ترین صادرکننده‌ی 
				\LTRfootnote{card issuer}
		بانک کانادا با ۶.۵ میلیون کارت بانکی، بانک شناخته شده‌ی پیشتاز در عرصه‌ی پرداخت می‌باشد. نرم‌افزار این بانک بر پایه‌ی تکنولوژی 			
...
و کارت بدهی 
		...
		\subsection{{\footnotesize \lr{ANZ‌ Bank}}}
		ویژگی : انتخاب روش پرداخت
		
		بانک 
			 {\large \lr{ANZ}
			 	استرلیا اخیرا در ضمینه‌ی پرداخت بدون تماس خبرساز بود. نرم‌افزار این بانک روش‌های مختلفی را برای اینکه کاربر چگونه فرآیند پرداخت خود را بر روی دستگاه خود آغاز کند، ارائه می‌دهد. کاربر می‌تواند انتخاب کند که یا دستگاه قبل از اینکه بخواهد پرداخت انجام دهد کاربر آن‌را فقط فعال کند و یا کاربر برنامه را اجرا کند قبل از پرداخت و یا کاربر با وارد کردن یک کد عبور آماده‌ی پرداخت شود. بدین ترتیب نرم‌افزار به کاربر اجازه می‌دهد
		...
		\subsection{{\footnotesize \lr{CaixaBank}}}
...
خود را ارائه کرد، و در سال ۲۰۱۶ 
	 			 {\large\lr{ImaginBank}}	 			 										 			 									 
		را معرفی کرد ، که با استفاده از نرم‌افزار 
			...
			 			 			 \end{figure}
			 			 			 		
				\subsection{{\footnotesize \lr{Capital One}}} 			 									 
 ...
 \end{figure}
 			...
 			\subsection{{\footnotesize \lr{SnapScan}}}
