...
{\let\cleardoublepage\clearpage 
	...
	\chapter{مقدمه}\label{introduction}
		...
		را در ماه فوریه‌ی ۲۰۱۵ معرفی کرد. سرویس‌های کیف‌پولی که این شرکت‌ها ارائه کرده اند، بر پایه‌ی تکنولوژی 
			{\large \lr	{Tokenisation}}
			می‌باشند، و از این تکنولوژی برای مدیریت کارت‌های بانکی استفاده می‌کنند. در فصل \ref{comparison} به مقایسه‌ی دو سرویس ارائه شده توسط این دو شرکت پرداخته خواهد شد، و علت برتری سرویس
							{\large \lr{Apple Pay}} 
							بیان خواهد شد. 
