...
\vspace*{0.8cm}
	...
	{\LARGE  ۱) استاد محترم داور }
	\textbf{\Large جناب آقای مهندس ابوالمعالی}
	\hspace*{2.6cm}
		{\LARGE امضا}

		\vspace*{0.7cm}
		
	{\LARGE ۲) استاد محترم راهنما }
	\textbf{\Large جناب آقای دکتر دری‌گیو}
	\hspace*{2.9cm}
	{\LARGE امضا}
		
			\vspace*{0.7cm}
	
	{\LARGE ۳) مدیر محترم گروه کامپیوتر }
	\textbf{\Large جناب آقای دکتر فدایی‌اسلام}
	\hspace*{1cm}
	{\LARGE امضا}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{latin}
		...
		\textbf{\huge Modeling, Design and Implementation of }			
		
		\vspace*{0.3cm}
					
		\textbf{\huge Mobile Payments and Digital Wallets:}			
		
		\vspace*{0.3cm}
		
		\textbf{\huge A Case Study}			
